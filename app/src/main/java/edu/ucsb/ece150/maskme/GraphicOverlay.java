...
public class GraphicOverlay extends View {
    ...
    private float mWidthScaleFactor = 3.2f;
    private float mHeightScaleFactor = 3.2f;
    ...
    public static abstract class Graphic {
        ...
        public float translateX(float x) {
            if (mOverlay.mIsCameraFacingFront) {
     ...
     */
    public void setCameraInfo(int previewWidth, int previewHeight, boolean isCameraFacingFront) {
        synchronized (mLock) {
            mPreviewWidth = previewWidth;
            mPreviewHeight = previewHeight;
            mIsCameraFacingFront = isCameraFacingFront;
        }
        postInvalidate();
    }
